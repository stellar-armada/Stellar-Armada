...
namespace LeiaLoft
{
    ...
    {
        public const string GameObjectName = "LeiaLoft.LeiaSettings";
        ...
        [SerializeField, HideInInspector]
        public string _leiaStateId = "HPO";
        [SerializeField, HideInInspector]
        public string _desiredLeiaStateId = "HPO";
        [SerializeField, HideInInspector]
        private int _antiAliasing = 1;
        [SerializeField, HideInInspector]
        private bool _SwitchModeOnSceneChange = true;
        ...
        public string DesiredLeiaStateID
        {
            get
            {
                return _desiredLeiaStateId;
            }
            set
            {
                _desiredLeiaStateId = value;
            }
        }
        ...
        public bool SwitchModeOnSceneChange
        {
            get
            {
                return _SwitchModeOnSceneChange;
            }
            set
            {
                _SwitchModeOnSceneChange = value;
            }
        }
