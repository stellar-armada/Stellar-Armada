    ...
    public class Lightning : MonoBehaviour
    {
        ...
        void OnSpawned()
        {
            ...
            if (Oscillate && Points > 0)
                OscillateTimerID = TimeManager.time.AddTimer(OscillateTime, OnOscillate);
        ...
        void OnDespawned()
        {
            ...
            {
                TimeManager.time.RemoveTimer(OscillateTimerID);
                OscillateTimerID = -1;
            }
        }
...
//                lineRenderer.SetVertexCount(2);
        ...
        void Animate()
        {
            ...
            // Add timer 
            FrameTimerID = TimeManager.time.AddTimer(FrameStep, OnFrameStep);
