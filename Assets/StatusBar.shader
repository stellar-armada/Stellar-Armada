    ...
    SubShader
    {
        ...
        Pass
        {
        	...
        	half4 frag (GraphVertexOutput IN  ) : SV_Target
            {
				...
				float2 uv010 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
...
Node;AmplifyShaderEditor.CommentaryNode;13;-421.5623,-89.43976;Float;False;698.6;207;Is Red?;6;5;3;2;1;17;14;;1,1,1,1;0;0
