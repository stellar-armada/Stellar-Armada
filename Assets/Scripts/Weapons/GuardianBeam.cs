    ...
    public class GuardianBeam : MonoBehaviour
    {
        ...
        void OnSpawned()
        {
            ...
            if (Oscillate && Points > 0)
                OscillateTimerID = TimeManager.instance.AddTimer(OscillateTime, OnOscillate);
        ...
        void OnDespawned()
        {
            ...
            {
                TimeManager.instance.RemoveTimer(OscillateTimerID);
                OscillateTimerID = -1;
            }
        }
...
//                lineRenderer.SetVertexCount(2);
        ...
        void Animate()
        {
            ...
            // Add timer 
            FrameTimerID = TimeManager.instance.AddTimer(FrameStep, OnFrameStep);
