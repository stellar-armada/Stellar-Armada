...
namespace StellarArmada.Networking
{
    ...
    {
        // Custom NetworkManager to handle the specifics of matches (as opposed to the LobbyNetworkManager)
        // Mostly vanilla, with the differences between this and base class being host management and OnStartServer calls
        // The rest is hooks for future customization and integration with a master server
        ...
        // Start as host? Since this is a server auth game, this is mostly just for debug
