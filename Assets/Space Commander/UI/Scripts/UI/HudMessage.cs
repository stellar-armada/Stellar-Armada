...
namespace SpaceCommander.UI
{
    ...
    public class HudMessage : MonoBehaviour
    {
        ...
        {
            if (HudMessageManager.instance.HasCurrentMessage())
            {
                HudMessageManager.GetCurrentMessage().HideMessage();
            }

            lastShown = Time.time;
            gameObject.SetActive(true);
            HudMessageManager.SetCurrentMessage(this);
            ...
            if (hapticAlert)
            {
                InputManager.HandleHaptics_Alert();
            }
        ...
        public void HideMessage()
        {
            ...
            if (HudMessageManager.GetCurrentMessage() == this)
            {
                HudMessageManager.ClearCurrentMessage();
            }
