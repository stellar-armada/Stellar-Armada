...
namespace SpaceCommander
{
    ...
    public class ShieldPostprocess : MonoBehaviour
    {
        ...
        private List<ShieldEffectController> shieldObjects = new List<ShieldEffectController>();
        ...
        public void AddShield(ShieldEffectController s)
        {
            if (!shieldObjects.Contains(s))
                shieldObjects.Add(s);
        }

        public void RemoveShield(ShieldEffectController s)
        {
            if (shieldObjects.Contains(s))
        ...
        void OnEnable()
        {
            ...
            ShieldEffectController[] shieldsEffectController = Object.FindObjectsOfType<ShieldEffectController>();
            foreach (ShieldEffectController s in shieldsEffectController)
            {
                AddShield(s);
            } 
        }
        ...
        void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            ...
            foreach (ShieldEffectController s in shieldObjects)
            {
